    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <strong>PRN TYPE:</strong>
                        <asp:DropDownList runat="server" ID="prnType" CssClass="form-control select2" OnSelectedIndexChanged="prnType_SelectedIndexChanged" AutoPostBack="true">
                            <asp:ListItem>Select</asp:ListItem>
                            <asp:ListItem Value="0">Exchequer</asp:ListItem>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <strong>Procurement Plan Id:</strong>
                        <asp:DropDownList ID="planId" runat="server" CssClass="form-control select2" Enabled="False"></asp:DropDownList>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="requisitionProductGroup" runat="server" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="requisitionProductGroup_SelectedIndexChanged">
                            ...
                            <asp:ListItem Value="2">Works</asp:ListItem>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:DropDownList runat="server" ID="fundCode" CssClass="form-control select2" Enabled="False" />
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <strong>
                            <asp:Label ID="tJob" runat="server" Text="Select Project:"></asp:Label></strong>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <strong>Procurement Plan Entry No:</strong>
                        <asp:DropDownList runat="server" ID="planEntryNo" CssClass="form-control select2" AutoPostBack="true" />
                    </div>
        ...
        <div class="panel-body">
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="form-group">
                    ...
                    <asp:TextBox runat="server" ID="quantityRequested" CssClass="form-control"  TextMode="Number"/>
                </div>
            </div>
            <div class="col-lg-6 col-sm-6">
                <div class="form-group">
                    <strong>Direct Unit Cost:</strong>
                    <asp:TextBox runat="server" ID="directUnitCost" CssClass="form-control" />
                </div>
            </div>

                ...
                <%
                    ...
                    <td>
                        <%
                            ...
                            {
                            %>
                        <a class="btn btn-success" href="StaffClaimApprovalComments.aspx?DocumentNo=<%=leave.Document_No %>&&Approver=<%=leave.Approver_ID %>"><label class="fa fa-eye">View Comment</label></a>
                    <%
                        }
                        else
                        {
      ...
      <div class="modal-body">
              <table class="table table-striped table-bordered"  style="width:100%">
                ...
                <%
                    ...
                    var ncomment = nav.ApprovalCommentLine.Where(x => x.Table_ID == ytableid && x.User_ID == mapproverId && x.Record_ID_to_Approve == "Payments:" + " " + docNo);

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegionalRiskManagementPlans.aspx.cs" Inherits="HRPortal.RegionalRiskManagementPlans" %>

<%@ Import Namespace="System.IO" %>
<%@ Import Namespace="HRPortal" %>
<asp:Content ID="Content3" ContentPlaceHolderID="MainBody" runat="server">
    <div class="panel panel-primary">
        <div class="panel-heading">Regional Risk Management Plans</div>
            ...
            <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                    <%
                        ...
                        var queryRisk = nav.managementPlans.Where(r => r.Document_Type == "Functional (Region)");
                        string DocType = "Functional (Region)";

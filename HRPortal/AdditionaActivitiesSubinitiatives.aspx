<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="AdditionaActivitiesSubinitiatives.aspx.cs" Inherits="HRPortal.AdditionaActivitiesSubinitiatives" %>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <strong>Unit of Measure:</strong>
                        <asp:DropDownList runat="server" ID="txtunitofmeasure" CssClass="form-control" AppendDataBoundItems="true">
                            <asp:ListItem>--Select Unit Of Measure--</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                     <div class="form-group">

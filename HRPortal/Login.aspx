            ...
            <div class="account-container">
                <div class="content clearfix">
                    ...
                    <div class="login-fields">
                        <div class="field">
                            <label for="username">Employee No/Id Number:</label>
                            <asp:TextBox runat="server" type="text" ID="username" name="username" value="" placeholder="Employee No/Id Number" CssClass="login username-field" required />
                        </div>
                        <div class="field">
                    ...
                    <hr />
                    <div>
                        <asp:Button runat="server" class="btn btn-success pull-right" Text="Log In" OnClick="Unnamed1_Click" />
                        <a class="btn btn-warning pull-left" href="ForgotPass.aspx">Reset Password</a>
                    </div>
                </div>
            </div>
        </form>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StandardAppraisalUnderEvaluation.aspx.cs" Inherits="HRPortal.StandardAppraisalUnderEvaluation" %>
                ...
                <div runat="server" id="documentsfeedback"></div>
                 <table id="example1" class="table table-bordered table-striped">
                    ...
                    <%
                        ...
                        var data = nav.PerfomanceEvaluation.Where(r => r.Supervisor_Staff_No == employeeNo && r.Closed == false && r.Evaluation_Type == "Standard Appraisal/Supervisor Score Only" && r.Approval_Status == "Released" && r.Document_Type == "Performance Appraisal" && r.Document_Status == "Evaluation");
                    ...
                    <tr>
                        ...
                        <td><a href="StandardAppraisalUnderEvaluationDetails.aspx?docNo=<%=item.No %>" class="btn btn-success"><i class="fa fa-eye"></i>Add Details</a> </td>

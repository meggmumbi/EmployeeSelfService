<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OpenEvaluation.aspx.cs" Inherits="HRPortal.OpenEvaluation" %>
            ...
            <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                    <%
                        ...
                        var trainingEvaluation = nav.TrainingEvaluation.Where(r => r.Employee_No == employeeNo && r.Status == "Open");
